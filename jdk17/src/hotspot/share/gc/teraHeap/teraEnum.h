#ifndef SHARE_GC_TERAHEAP_TERAENUMS_HPP
#define SHARE_GC_TERAHEAP_TERAENUMS_HPP
...
enum actions {
  NO_ACTION,                      //< Do not perform any action
  SHRINK_HEAP,                    //< Shrink H1 because the I/O is high
  GROW_HEAP,                      //< Grow H1 because the GC is high
  CONTINUE,                       //< Continue not finished interval
  IOSLACK,                        //< IO slack for page cache to grow
  WAIT_AFTER_GROW                 //< After grow wait to see the effect
};
...
#endif // SHARE_GC_TERAHEAP_TERAENUMS_HPP
