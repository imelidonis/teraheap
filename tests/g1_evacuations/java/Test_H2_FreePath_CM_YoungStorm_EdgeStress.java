 ...
 */
public class Test_H2_FreePath_CM_YoungStorm_EdgeStress {
  ...
  public static void main(String[] args) throws Exception {
    // Core knobs
    final int CYCLES              = (args.length > 0) ? Integer.parseInt(args[0]) : 15;
    final int NUM_ROOTS           = (args.length > 1) ? Integer.parseInt(args[1]) : 256;
    final int ROOT_LEN            = (args.length > 2) ? Integer.parseInt(args[2]) : 6000;
    ...
    final int NULL_SLOTS_PER_CYCLE= (args.length > 6) ? Integer.parseInt(args[6]) : 3_000_000;

    // Verification knobs
    final int TOUCH_SAMPLES_PER_CYCLE = (args.length > 7) ? Integer.parseInt(args[7]) : 15_000;
    ...
    final int H1_HUM_MIN_MB        = (args.length > 10) ? Integer.parseInt(args[10]) : 4;
    final int H1_HUM_MAX_MB        = (args.length > 11) ? Integer.parseInt(args[11]) : 16;
